        ...
        <div class="bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center gap-3 flex-grow-1 me-4">
                ...
                <div class="input-group input-group-sm" style="max-width: 400px;">
                    ...
                    <input type="text" id="searchInput" class="form-control bg-light border-0" placeholder="Buscar por nombre o documento...">
                </div>
            </div>
            <button class="btn btn-success btn-sm rounded-pill px-3 fw-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalCrearUsuario">
                <i class="fas fa-user-plus me-1"></i> Nuevo Contratista
            </button>
        </div>
