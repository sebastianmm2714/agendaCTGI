...
class LegalizacionPersonalController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('legalizacion.personal.index', compact('users', 'categorias', 'supervisores', 'ordenadores'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('legalizacion.personal.index')
